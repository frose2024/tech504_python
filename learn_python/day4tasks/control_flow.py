...
film_rating = input("What classification is the film you're trying to watch? ")
...
#   got confused here using the OR bit, but need to explicitly state what's being compared. 
